...
class _ColegioTabState extends State<ColegioTab> {
  ...
  void _showColegioDialog({Colegio? colegio}) {
    ...
    final direccionController = TextEditingController(text: colegio?.direccion ?? '');
    final telefonoController = TextEditingController(text: colegio?.telefono ?? '');
    final emailController = TextEditingController(text: colegio?.email ?? '');
    final directorController = TextEditingController(text: colegio?.director ?? '');
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return CustomCard(
                    ...
                    backgroundColor: provider.selectedColegio?.id == colegio.id
                        ...
                        Row(
                          ...
                          children: [
                            IconButton(
                              ...
                              onPressed: () => _showColegioDialog(colegio: colegio),
                            ),
                            IconButton(
